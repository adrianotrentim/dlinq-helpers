    ...
    public static class QueryableExtensions
    {
        ...
        private static IQueryable<T> Filter<T>(IQueryable<T> queryable, Filter filter)
        {
            if (filter != null && filter.Logic != null)
            {
                ...
                //Convert values to properties types
                //var properties = queryable.ElementType.GetProperties();
                //foreach (var item in filters)
                //{
                //    var propInfo = properties.FirstOrDefault(t => t.Name == item.Field);
                //    if (item.Value != "" && item.Value != null)
                //    {

                //        if (propInfo.PropertyType == typeof(decimal) || propInfo.PropertyType == typeof(decimal?))
                //        {
                //            item.Value = Convert.ToDecimal(item.Value.ToString());
                //        }
                //        else if (propInfo.PropertyType == typeof(DateTime) || propInfo.PropertyType == typeof(DateTime?))
                //        {
                //            item.Value = Convert.ToDateTime(item.Value.ToString());
                //        }
                //        else if (propInfo.PropertyType == typeof(int) || propInfo.PropertyType == typeof(int?))
                //        {
                //            item.Value = Convert.ToInt32(item.Value.ToString());
                //        }
                //        else if (propInfo.PropertyType == typeof(Guid) || propInfo.PropertyType == typeof(Guid?))
                //        {
                ...
                //    //item.Value = Convert.ChangeType(item.Value, propInfo.PropertyType);
                //}
